...
parser.add_argument("--batchid", default=1, help='the batch for id')
parser.add_argument("--batchimage", default=1, help='the batch of per id')
parser.add_argument("--batchtest", default=1, help='the batch size for test')
